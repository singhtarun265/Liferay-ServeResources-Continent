...
public interface CountryLocalService
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Country deleteCountry(String countryCode) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Country getCountry(String countryCode) throws PortalException;
