 ...
 * <code>com.liferay.serve.resource.service.impl.CountryLocalServiceImpl</code> and
...
public class CountryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.serve.resource.service.impl.CountryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Country deleteCountry(String countryCode)
		throws PortalException {
	...
	public static Country fetchCountry(String countryCode) {
		return getService().fetchCountry(countryCode);
	}

	public static List<Country> getByContinentCode(String continentCode)
		throws SystemException {

		return getService().getByContinentCode(continentCode);
	}
