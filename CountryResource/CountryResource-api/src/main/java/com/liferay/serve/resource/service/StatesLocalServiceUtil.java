...
/**
 * Provides the local service utility for States. This utility wraps
 * <code>com.liferay.serve.resource.service.impl.StatesLocalServiceImpl</code> and
 ...
 * @generated
 */
public class StatesLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.serve.resource.service.impl.StatesLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static States addStates(States states) {
		return getService().addStates(states);
	}
	 ...
	 */
	public static States createStates(String stateAbbrev) {
		return getService().createStates(stateAbbrev);
	}
	 ...
	 */
	public static States deleteStates(States states) {
		return getService().deleteStates(states);
	}
	 ...
	 */
	public static States deleteStates(String stateAbbrev)
		throws PortalException {

		return getService().deleteStates(stateAbbrev);
	}
	...
	public static States fetchStates(String stateAbbrev) {
		return getService().fetchStates(stateAbbrev);
	}

	public static List<States> getByCountryCode(String countryCode)
		throws SystemException {

		return getService().getByCountryCode(countryCode);
	}
	 ...
	 * @throws PortalException if a states with the primary key could not be found
	 */
	public static States getStates(String stateAbbrev) throws PortalException {
		return getService().getStates(stateAbbrev);
	}
	 ...
	 */
	public static List<States> getStateses(int start, int end) {
		return getService().getStateses(start, end);
	}
	 ...
	 */
	public static int getStatesesCount() {
		return getService().getStatesesCount();
	}
	 ...
	 */
	public static States updateStates(States states) {
		return getService().updateStates(states);
	}

	public static StatesLocalService getService() {
		return _service;
	}

	private static volatile StatesLocalService _service;
